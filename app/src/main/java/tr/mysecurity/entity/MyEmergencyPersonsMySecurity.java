...
public class MyEmergencyPersonsMySecurity {

    private static final String TEXT_TABLE_NAME = "MY_EMERGENCY_PERSON_MY_SECURITY";
    ...
    public MyEmergencyPersonsMySecurity() {
    }
